...
interface ZohoApprovalModalProps {
  open: boolean;
  onClose: () => void;
  campaignData: {
    name?: string;
...
export default function ZohoApprovalModal({
  open,
  onClose,
  campaignData,
  tasks,
      ...
      {open && (
        <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
          ...
          <motion.div
            role="dialog"
            aria-modal="true"
            aria-label="Approve and push to Zoho"
          ...
          >
            ...
            <div className="px-6 pt-5 pb-4 flex items-start justify-between gap-3 flex-shrink-0">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-[15px] font-bold text-stone-900 tracking-[-0.01em]">
            ...
            <div className="flex-1 min-h-0 overflow-y-auto px-6 pb-5 space-y-5">
              ...
              <div>
                ...
                <ul className="space-y-0">
                  {ZOHO_ACTIONS.map(({ icon: Icon, title, detail }, i) => (
                    <li
                      key={title}
              ...
              <p className="text-[11.5px] text-stone-500 leading-relaxed">
                {source ? `${source}. ` : ""}
                This creates live records in Zoho CRM, Projects and Books and marks the plan{" "}
                <strong className="text-stone-700 font-semibold">Approved</strong>. Your sign-off is recorded.
              </p>
            </div>
