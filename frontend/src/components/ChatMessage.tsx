                ...
                components={{
                  p: ({ children }) => {
                    ...
                    if (text.includes("[Confirmed Information]")) {
                      return (
                        <div className="my-3 p-4 rounded-xl bg-indigo-50/70 border border-indigo-200/80 shadow-xs">
                    ...
                    if (text.includes("[Historical Precedent]")) {
                      return (
                        <div className="my-3 p-4 rounded-xl bg-sky-50/70 border border-sky-200/80 shadow-xs">
                    ...
                    if (text.includes("[Risk]")) {
                      return (
                        <div className="my-3 p-4 rounded-xl bg-amber-50/70 border border-amber-200/80 shadow-xs">
                    ...
                    if (text.includes("[PENDING_HUMAN_SIGN_OFF]")) {
                      return (
                        <div className="my-3 p-4 rounded-xl bg-rose-50/80 border border-rose-200/90 shadow-xs">
